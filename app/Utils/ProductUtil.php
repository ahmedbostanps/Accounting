...
//        wordwrap($string_1, 20, " $string_2  <br>");
        return round(substr_replace($val, '.', 2, 0) , 2);

//        return $val / 2.20462;
    }
    public function getDetailsFromVariation($variation_id, $business_id, $location_id = null, $check_qty = true , $weighing_barcode = null)
    {
//        return $business_id;
...
//            return "helllo";
//            return $weighing_barcode;
            $query = $query->where(function ($query) use ($variation_id) {
        ...
        if($weighing_barcode) {
//            return $weighing_barcode;
            $query = $query->where(function ($query) use ($weighing_barcode) {
                $query->where('variations.sub_sku', '=' , $weighing_barcode);
            });
