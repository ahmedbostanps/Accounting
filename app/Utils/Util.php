...
//        return $notifications;
        foreach ($notifications as $notification) {
            ...
            return in_array($notification->type, [\App\Notifications\RecurringInvoiceNotification::class, \App\Notifications\RecurringExpenseNotification::class]);
...
//                return $module_notification_data;
