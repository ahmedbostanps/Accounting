					...
					<div class="col-md-6">
				        ...
				        <div class="form-group">
				            ...
				            <div class="input-group">
				                ...
				                {!! Form::select('discount_type_modal', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'fixed' , ['class' => 'form-control','placeholder' => __('messages.please_select'), 'required']); !!}
				            </div>
				        </div>
				    </div>
{{--				    @php--}}
