<div class="row pos_form_totals">
	<div class="col-md-12">
		<table class="table table-condensed" id="table_pos_form_total">
			<tr>
			...
			<tr>
				<td class="@if(!$is_discount_enabled) hide @endif">
					<b class="discount_control">
...
{{--						<i class="fas fa-edit cursor-pointer" id="pos-edit-discount" title="@lang('sale.edit_discount')" aria-hidden="true" data-toggle="modal" data-target="#posEditDiscountModal"></i>--}}
							{!! Form::select('discount_type_modal', ['fixed' => __('lang_v1.fixed'), 'percentage' => __('lang_v1.percentage')], 'fixed' , ['class' => 'form-control hide','placeholder' => __('messages.please_select'), 'required']); !!}
{{--							@php--}}
{{--								$discount_type = 'fixed';--}}
...
{{--							@endphp--}}
							{!! Form::text('discount_amount_modal', @num_format(0), ['class' => 'form-control input_number', 'id' => 'discount_amount_modal' , 'data-max-discount' => '', 'data-max-discount-error_msg' => __('lang_v1.max_discount_error_msg') ]); !!}
