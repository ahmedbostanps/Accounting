...
{{--		</div>--}}
		<div class="col-md-12">
			<div class="eq-height-row row" style="padding: 15px; padding-top: 0px;">
				<div class="col-sm-2 col-xs-4 product_list no-print " style="    display: flex;
    justify-content: center;">
					<div class="my-product_box active" data-category="all" title="الكل" style="    height: 80px;
    width: 100%;
    display: flex;
    justify-content: center;
    align-items: center;
    border-radius: 5px;">
						...
						<div class="text_div">
							<small class="text text-muted">الكل
							</small>
					...
					@foreach($categories as $category)
						<div class="col-sm-2 col-xs-4 product_list no-print" style="    display: flex;
    justify-content: center;">
							<div class="my-product_box" data-category="{{ $category['id'] }}" title="{{ $category['name'] }}" style="    height: 80px;
    width: 100%;
    display: flex;
    justify-content: center;
    align-items: center;
    border-radius: 5px;">
								...
								<div class="text_div">
									<small class="text text-muted">{{ $category['name'] }}
									</small>
